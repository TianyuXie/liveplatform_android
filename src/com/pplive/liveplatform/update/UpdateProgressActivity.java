...
public class UpdateProgressActivity extends Activity
{
            ...
            public void run()
            {
                ...
                if (DownManager.error && !isFinishing())
                {
                    runOnUiThread(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            Toast.makeText(UpdateProgressActivity.this, R.string.download_error, Toast.LENGTH_LONG).show();
                        }
                    });
                }
    ...
    class ProgressView extends View
    {
        ...
        protected void onDraw(Canvas canvas)
        {
            ...
            canvas.drawText(DownManager.cLen + "/" + DownManager.len + " "
                    + ((int) (1f * DownManager.cLen / DownManager.len * 10000)) / 100f + "%", w / 2 - 50, h / 2 - 8,
                    mPaint);
            invalidate();
        }
