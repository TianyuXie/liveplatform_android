...
public class ProgramService extends AbsService {
    ...
    private static final String TEMPLATE_GET_PROGRAMS = new Url(Url.Schema.HTTP, Constants.TEST_HOST, Constants.TEST_PORT, "/ft/v1/owner/{owner}/programs")
            .toString();
    ...
    private static final String TEMPLATE_UPDATE_PROGRAM = new Url(Url.Schema.HTTP, Constants.TEST_HOST, Constants.TEST_PORT, "/ft/v1/program/{programid}/info")
            .toString();

    private static final String TEMPLATE_DELETE_PROGRAM = new Url(Url.Schema.HTTP, Constants.TEST_HOST, Constants.TEST_PORT, "/ft/v1/program/{programid}")
            .toString();
