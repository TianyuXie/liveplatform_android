package com.pplive.liveplatform.ui.widget.refresh;
...
public class AdvancedRefreshListView extends SwipeListView {
    ...
    public AdvancedRefreshListView(Context context) {
        this(context, null);
    }

    public AdvancedRefreshListView(Context context, AttributeSet attrs) {
        super(context, attrs);
