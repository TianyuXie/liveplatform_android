...
package com.pplive.liveplatform.widget.swipe;
...
public interface SwipeListViewListener {
    ...
    /**
     * Used when user want to change swipe list mode on some rows. Return SWIPE_MODE_DEFAULT if you don't want to change
     * swipe list mode
     * 
     * @param position
